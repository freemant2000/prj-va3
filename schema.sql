...
insert into word_meanings values(1, 0, 'adj', '陡峭（斜）的');
insert into word_defs values(2, 'mountain');
insert into word_meanings values(2, 0, 'n', '山');
insert into word_defs values(3, 'flow');
insert into word_meanings values(3, 0, 'v', '流動');
insert into word_meanings values(3, 1, 'n', '流');
insert into word_defs values(4, 'trunk');
insert into word_meanings values(4, 0, 'n', '樹幹');
insert into word_meanings values(4, 1, 'n', '象鼻');
insert into word_meanings values(4, 2, 'n', '大木箱');
insert into word_defs values(5, 'squirrel');
insert into word_meanings values(5, 0, 'n', '松鼠');
insert into word_defs values(6, 'valley');
insert into word_meanings values(6, 0, 'n', '山谷');
insert into word_defs values(7, 'rock');
insert into word_meanings values(7, 0, 'n', '岩石');
insert into word_defs values(8, 'scared');
insert into word_meanings values(8, 0, 'adj', '害怕的');
insert into word_defs values(9, 'opposite');
insert into word_meanings values(9, 0, 'adj', '相反的');
insert into word_defs values(10, 'direction');
insert into word_meanings values(10, 0, 'n', '方向');
insert into word_defs values(11, 'horn');
insert into word_meanings values(11, 0, 'n', '（動物）角');
insert into word_meanings values(11, 1, 'n', '號角');
insert into word_defs values(12, 'gap');
insert into word_meanings values(12, 0, 'n', '空隙');
insert into word_defs values(13, 'wise');
insert into word_meanings values(13, 0, 'adj', '明智的');
insert into word_defs values(14, 'jackal');
insert into word_meanings values(14, 0, 'n', '豺');
insert into word_defs values(15, 'greedy');
insert into word_meanings values(15, 0, 'adj', '貪心的');
insert into word_defs values(16, 'blood');
insert into word_meanings values(16, 0, 'n', '血');
insert into word_defs values(17, 'goat');
insert into word_meanings values(17, 0, 'n', '山羊');
insert into word_defs values(18, 'injure');
insert into word_meanings values(18, 0, 'v', '使受傷');
insert into word_defs values(19, 'fight');
insert into word_meanings values(19, 0, 'n', '打鬥');
insert into word_meanings values(19, 1, 'v', '打鬥');
insert into verb_forms values(19, 'fought', 'fought', NULL);
insert into word_defs values(20, 'river');
insert into word_meanings values(20, 0, 'n', '河流');
